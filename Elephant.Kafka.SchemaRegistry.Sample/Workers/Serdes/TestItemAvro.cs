...
namespace Elephant.Kafka.SchemaRegistry.Sample.Workers.Serdes;

public class TestItemAvro : ISpecificRecord
{
    ...
    {
        return $"Id: {Id}, Name: {Name}, Value: {Value}, CreatedAt: {CreatedAt}";
    }
}